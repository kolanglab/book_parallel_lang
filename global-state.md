...
シンボル表は典型的に **読み込みが圧倒的に多く、書き込み（新規 intern）は稀** です。この特性は、第8章で見た RCU[](#cite:mckenney1998) や read-write ロック（読みは共有、書きは排他）が効く場面です。「ほとんど読み、たまに書く」共有状態は、処理系のあちこちに現れる重要なパターンです。
